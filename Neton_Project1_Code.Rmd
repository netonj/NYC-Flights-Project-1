...
flights_joined <- flights_joined %>% 
  filter(departure_delay > 0) #filter out departure delays to only show observations where the flight was delayed 
...
Comments
 - 24,000 of the 27,000 observations have a 0 value
